...
public class QiangKaFuWu {
    ...
    private final static String MPName = "强卡服务";
    private final static String ClearScreenText = "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n天王盖地虎";   //进入人工客服前清屏
    private final static String StartText1 = "排队";
    private final static String CustomerServiceName = "强卡助手";
...
//            System.out.println("afterClass quit...");
    ...
    private boolean checkMPName(String mpName) {
        List<WebElement> els = null;
        WebElement el = null;
        el = androidDriver.findElementById("com.tencent.mm:id/hn");
        if (el != null) {
    ...
    private boolean findKeyBoard() {
        ...
        el = androidDriver.findElementById("com.tencent.mm:id/aas");
        if (el != null) {
            el.click();
